 ...
 * @Description: 鏂囦欢鐨勯�閰嶅櫒
 * @author andy.xu
 * @date 2014-8-24 涓嬪崍6:51:00
 * 
 */
public class FileAdapter extends BaseAdapter {
	...
	public FileAdapter(Context context, List<String> items,
		...
		this.folder = BitmapFactory.decodeResource(context.getResources(),
				R.drawable.folder);
		this.back = BitmapFactory.decodeResource(context.getResources(),
				R.drawable.fileback);
		this.filetype = BitmapFactory.decodeResource(context.getResources(),
				R.drawable.filetype);
		this.pkey = BitmapFactory.decodeResource(context.getResources(),
				R.drawable.p12);
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (filenames.get(position).toString().equals("back")) {
			...
			holder.nameView.setText(R.string.im_back_str);
		} else {
