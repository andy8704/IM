...
import com.xmpp.im.client.listener.MultiChatListener;
 ...
 * 
 * 
 * @类名称: IMChatRoomClientActivity
 * @描述: 客户端聊天
 * @开发者: andy.xu
 * @时间: 2014-8-25 上午11:12:33
 * 
 */
public class IMChatRoomClientActivity extends Activity implements IXListViewListener {
	...
	private MultiUserChat mCurChat = null;
	...
	private ImageView mGroupInfoBtn = null;

	@Override
	public void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.chatroomclient);
...
//		onGetLastMessage();
	...
	private void initUI() {
		...
		mGroupInfoBtn = (ImageView) findViewById(R.id.group_btn_id);
		

		mCurChat = XmppTool.joinMultiUserChat(mCurUserId, mChatRoomName, "");
		mCurChat.addMessageListener(new MultiChatListener());
...
//		mCurChat = cm.createChat(mUserChatId, null);
		...
		mTitleView.setText(mChatRoomName);
	}
	...
	private void initListener() {
		...
		mGroupInfoBtn.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
	...
	private View.OnClickListener mClick = new View.OnClickListener() {
		...
		public void onClick(View view) {
			...
			case R.id.pic_btn_id:
				BitmapDecodeUtil.onGallery(IMChatRoomClientActivity.this);
				mMenuView.setVisibility(View.GONE);
				break;
			case R.id.camera_btn_id:
				mCameraPicPath = Environment.getExternalStorageDirectory().getAbsolutePath() + "/temp/camera.jpg";
				BitmapDecodeUtil.onCamera(IMChatRoomClientActivity.this, mCameraPicPath);
				mMenuView.setVisibility(View.GONE);
				break;
			case R.id.file_btn_id:
				Intent intent = new Intent(IMChatRoomClientActivity.this, FormFilesActivity.class);
...
//					ImApplication.onGetInstance().onGetDB().onAddMessage(outMsg);
	...
	private void onReciveFile(){
		...
		AlertDialog.Builder builder = new AlertDialog.Builder(IMChatRoomClientActivity.this);
...
//		ImUtil.onSetCurChatUserId(null);
	...
	private void registerBroadcast() {
		...
		IntentFilter filter = new IntentFilter(IMCommDefine.broadcast_chatroom_msg);
...
//		msgData.fromFlag = 0;
//		if(!TextUtils.isEmpty(msgData.toUser)){
//			if(msgData.toUser.contains(mCurUserId))
//				msgData.fromFlag = 1;
//		}
